...
function Dashboard(props) {
  ...
  const drawer = (
    <div>
      <Toolbar>
        <img src={logo} width="100px" className="mb-0" alt="" />
      </Toolbar>
      <Divider />
      <div className="text-start p-2">
        ...
        {admin && <Box>
          <Link to={`${url}/addCars`} style={{textDecoration: 'none'}}><Button color="inherit">Add Cars</Button></Link>
          <Link to={`${url}/allCars`} style={{textDecoration: 'none'}}><Button color="inherit">All Cars</Button></Link>
